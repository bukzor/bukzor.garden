...
- **KYC-bound, console-only:** legal name, business name, statement
  descriptor, activation questionnaire. Stripe will not let an API key
  rewrite the account's verified identity, by design.
